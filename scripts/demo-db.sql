...
-- Insert data
INSERT INTO public."Books" (id, author, title, subtitle, "imgUrl", description, genres, "createdAt", "updatedAt", content, scss)
VALUES 
    (
      1,
      'George Orwell', 
...
INSERT INTO public."Pages" (reference, html, options, scss)
VALUES 
    (
    '200',
