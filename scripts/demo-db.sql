...
-- Insert data
INSERT INTO public."Books" (id, author, title, subtitle, "imgUrl", description, genres, "createdAt", "updatedAt", content)
VALUES 
    (
      1,
      'George Orwell', 
...
INSERT INTO public."Pages" (reference, html, options)
VALUES 
    (
    '200',
